...
| **Text → Speech** | Cartesia | Cartesia |
| **Avatar** | Beyond Presence / Tavus | Beyond Presence / Tavus |
...
2. `fetch_slots` - *Assume hard-coded available slots*
...
4. ***[Optional Bonus]*** Estimate and show cost incurred at the end of each call with breakup
